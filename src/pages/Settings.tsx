...
const Settings = () => {
  ...
  }, [profile?.monthly_income, profile?.full_name]);
    ...
    <div className="space-y-6">
        ...
        <Card className="card-glass shadow-elevation-2">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="currency" value={profile?.currency || "INR (₹)"} disabled className="bg-muted/50" />
            </div>
            <div className="space-y-2">
      ...
      <MotionWrapper delay={0.35}>
        <div className="flex justify-end">
          <Button onClick={handleGeneralSave} className="px-8 shadow-elevation-2">
            Save Changes
          </Button>
        </div>
      </MotionWrapper>
