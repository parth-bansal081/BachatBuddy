...
const Onboarding = () => {
    ...
    const handleSystemReset = async () => {
        try {
            ...
            sonnerToast.success("System Reset: Clean Slate and Cache Purged.");
                ...
                {step === 0 && (
                    <Card className="border-0 bg-black/60 backdrop-blur-xl shadow-2xl relative overflow-hidden">
                        <CardHeader className="text-center pb-2">
                            <div 
                                className="w-12 h-12 bg-primary/20 rounded-full flex items-center justify-center mx-auto mb-4 cursor-pointer"
                                onClick={onLogoClick}
                            >
